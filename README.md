...
React Toast Alerts is a simple and customizable toast notification component for React applications.



## Installation

You can install React Toast Alerts via npm:
...
To use React Toast Alerts in your React/Nextjs application, follow these steps:

Import the useNotification hook and necessary styles in your component:

```jsx
import useNotification from "react-toast-Alerts";
```
...
Here's a basic example of how to use React Toast Alerts:
